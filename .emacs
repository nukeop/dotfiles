(custom-set-variables
 ...
 '(package-selected-packages
   '(rebecca-theme org highlight-parentheses rainbow-delimiters anaconda-mode solarized-theme react-snippets yasnippet ac-anaconda emmet-mode smartparens ag gotham-theme helm projectile neotree markdown-mode magit flycheck auto-complete))
 '(wakatime-api-key "")
